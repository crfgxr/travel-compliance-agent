...
def main():
            ...
            with st.spinner("Running compliance audit..."):
                ...
                if json_errors:
                    ...
                    if travel_approval and flight_reservations:
                        ...
                        # Store the report in session state FIRST for persistence
                        ...
                        # Clear any loading states to ensure UI properly resets
                        st.session_state.loading_sample = False

                        # Force UI refresh to update sidebar and show reset button
                        st.rerun()
        else:
            show_notification(
    ...
    # Display stored audit results if audit completed but not currently running
